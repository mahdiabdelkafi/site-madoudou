...
import portraitImg from "@/assets/doc.jpg";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Dr. ABDELKAFI Mohamed Taha" },
	  { name: "google-site-verification", content: "ZrolQF_Scd4V2D6GbcUxxbMA6FAmpJ9chTnkpjcldl0" },
      { property: "og:title", content: "Dr. ABDELKAFI Mohamed Taha — Chirurgien digestif" },
      { property: "og:description", content: "Expert en chirurgie viscérale et digestive. Spécialiste en chirurgie mini-invasive." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Dr. ABDELKAFI Mohamed Taha — Chirurgien digestif" },
      { name: "twitter:description", content: "Expert en chirurgie viscérale et digestive. Spécialiste en chirurgie mini-invasive." },
    ],
  }),
  component: Index,
});
          ...
          <div>
            ...
            <div className="space-y-6">
              {[
                ...
                { icon: Building2, text: "Activité privée à la Clinique du Centre" },
              ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-5">
             <a href="https://wa.me/21698687981" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:text-accent transition">
